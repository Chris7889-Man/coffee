...
<body>
    <div id="wrapper">
        <nav class="sidebar">
            ...
            <a href="manage_menu.php" class="nav-link"><i class="fas fa-mug-hot"></i><span
                    class="ms-2 d-none d-lg-inline">Kelola Menu</span></a>
            ...
            <a href="contoh.php" class="nav-link"><i class="fas fa-dollar-sign"></i><span
                    class="ms-2 d-none d-lg-inline">Keuangan</span></a>
            <a href="laporan_harian.php" class="nav-link"><i class="fas fa-file-lines"></i><span
                    class="ms-2 d-none d-lg-inline">Laporan</span></a>


            <a href="data_staff.php" class="nav-link"><i class="fas fa-users-cog"></i><span
                    class="ms-2 d-none d-lg-inline">Staff</span></a>

            <?php if (!empty($_SESSION['is_super_admin'])): ?>
                <a href="manage_admin.php" class="nav-link"><i class="fas fa-user-shield"></i><span
                        class="ms-2 d-none d-lg-inline">Kelola Admin</span></a>
            <?php endif; ?>
            <div class="user-info mt-auto d-none d-lg-flex align-items-center justify-content-between">
                <span><i class="fas fa-user-circle"></i>
                    <?= htmlspecialchars($_SESSION['admin_nama'] ?? 'Admin') ?></span>
