...
<body>
    <div class="container mt-4">
        ...
        <section class="reset-history-section" aria-labelledby="reset-history-title" role="region">
            <h4 id="reset-history-title">Reset Riwayat Perubahan Stok</h4>

            <div class="reset-warning" role="alert" aria-live="assertive" aria-atomic="true">
                <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-exclamation-triangle-fill" viewBox="0 0 16 16" role="img" aria-label="Perhatian">
                    <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.71c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
                </svg>
                <span>Perhatian! Menghapus riwayat stok tidak dapat dibatalkan. Harap pastikan data yang dihapus sudah benar.</span>
            </div>

            <form method="POST" class="row g-3 mt-3" novalidate>
                <input type="hidden" name="action" value="reset_history" />
                <div class="col-md-3">
                    <label for="tgl_mulai" class="form-label">Tanggal Mulai Penghapusan</label>
                    <input type="date" id="tgl_mulai" name="tgl_mulai" class="form-control" required />
                </div>
                <div class="col-md-3">
                    <label for="tgl_akhir" class="form-label">Tanggal Akhir Penghapusan</label>
                    <input type="date" id="tgl_akhir" name="tgl_akhir" class="form-control" required />
                </div>
                <div class="col-md-3">
                    <label for="password" class="form-label">Password Reset Penghapusan</label>
                    <input type="password" id="password" name="password" class="form-control" required placeholder="Masukkan password admin" autocomplete="off" />
                </div>
                <div class="col-md-3 d-flex align-items-end">
                    <button type="submit" class="btn btn-danger w-100" onclick="return confirm('Apakah Anda yakin ingin menghapus riwayat stok sesuai rentang tanggal? Proses ini tidak bisa dibatalkan!')">
                        Reset Riwayat
                    </button>
                </div>
            </form>
