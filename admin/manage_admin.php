                ...
                <div>
                    <?php if ($show_add_admin_form): ?>
                        <form method="POST" class="d-inline">
                            <button type="submit" name="logout_access" class="btn btn-outline-warning btn-sm" title="Tutup Form Tambah Admin">
            ...
            <form method="POST" class="modal-content" novalidate autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="password" name="admin_access_password" id="admin_access_password" class="form-control" placeholder="******" required autofocus />
                    </div>
