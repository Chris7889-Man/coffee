...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO pesanan (
                kode_pesanan, nama_pelanggan, kode_menu, total_harga,
                tgl_pesanan, status_pesanan, jenis_pesanan, catatan_pesanan
              ) VALUES (
                :kode_pesanan, :nama_pelanggan, :kode_menu, :total_harga,
                :tgl_pesanan, :status_pesanan, :jenis_pesanan, :catatan
              )";
    $stmt = $db->prepare($query);
...
<div class="container mt-4">
    ...
    <form method="POST">
        ...
        <div class="mb-3">
            ...
            <textarea name="catatan_pesanan" class="form-control" rows="2"></textarea>
        </div>
